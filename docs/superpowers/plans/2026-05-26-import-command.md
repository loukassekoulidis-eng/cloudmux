...
Expected: detects active Azure session (wbai-azure is logged in), but may fail because profile name already exists. That's correct behavior — import is for new profiles.
